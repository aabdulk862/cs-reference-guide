...
- [Docker & Containerization](./docker-containerization.md) - CI/CD pipelines build and push container images as deployment artifacts
- [Kubernetes & EKS](./kubernetes-eks.md) - Kubernetes is the primary deployment target for containerized CI/CD pipelines
