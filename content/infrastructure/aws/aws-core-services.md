...
- **Lambda cold start amplification**: Placing Lambda functions inside a VPC adds 5-10 seconds of cold start time due to ENI attachment. Use VPC only when the function genuinely needs private resource access
